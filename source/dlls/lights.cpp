...
void CLight :: Spawn( void )
{
	...
	this->SaveDataForReset();
}

void CLight::SaveDataForReset()
{
	this->mSavedSpawnFlags = this->pev->spawnflags;
	this->mSavedStyle = this->m_iStyle;
	this->mSavedPattern = this->m_iszPattern;
}

void CLight::ResetEntity()
{
	this->pev->spawnflags = this->mSavedSpawnFlags;
	this->m_iStyle = this->mSavedStyle;
	this->m_iszPattern = this->mSavedPattern;
